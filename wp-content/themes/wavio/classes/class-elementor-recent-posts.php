...
if (!class_exists('Peerduck_Recent_Posts')) {
    class Peerduck_Recent_Posts extends Widget_Base
    {
        ...
        protected function _register_controls()
        {
            ...
            $this->add_control(
                'number_of_posts',
                [
                    'label' => esc_html__('Number of posts', 'wavio'),
                    'label_block' => true,
                    'type' => Controls_Manager::NUMBER,
                    'placeholder' => esc_html__('Enter number of posts', 'wavio'),
                    'min' => 3,
                    'max' => 9,
                    'step' => 3,
                    'default' => 3,
