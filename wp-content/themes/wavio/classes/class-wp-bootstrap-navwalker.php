...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) :
    ...
    class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
        ...
        public static function fallback( $args ) {
            ...
            $fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'wavio' ) . '">' . esc_html__( 'Add a menu', 'wavio' ) . '</a></li>';
            $fallback_output .= '</ul>';
