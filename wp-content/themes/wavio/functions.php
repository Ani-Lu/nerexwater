...
function wavio_theme_support()
{
     ...
     */
    load_theme_textdomain('wavio', get_template_directory() . '/languages');
...
function wavio_action_theme_register_required_plugins()
{
    ...
    tgmpa(array(
        ...
        array(
            'name' => esc_html__('Premium Addons for Elementor', 'wavio'),
...
function wavio_filter_theme_fw_ext_backups_demos($demos)
{
    $demos_array = array(
        'wavio-demo' => array(
            ...
            'screenshot' => 'https://peerduck.com/wp-content/uploads/themes/wavio/v2-s7wvKhR6UaBa69cu/screenshot.png',
            'preview_link' => 'https://wavio.peerduck.com',
        ),
    );

    $download_url = 'http://peerduck.com/wp-content/uploads/themes/wavio/v2-s7wvKhR6UaBa69cu/';
