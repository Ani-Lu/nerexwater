...
<form class="woocommerce-form woocommerce-form-login login" method="post" <?php echo wp_kses((( $hidden ) ? 'style="display:none;"' : ''), 'woo-style'); ?>>
	...
	<div class="form-row woo-bottom-f-row">
        ...
        <div class="login-btn"><button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button></div>
	</div>
